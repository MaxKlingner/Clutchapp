/**
 * Applique reset_matches.sql (TRUNCATE + policies DELETE) via Management API.
 * Usage: node scripts/apply-reset-matches.mjs
 */
...
const query = fs.readFileSync(
  path.join(root, 'supabase', 'reset_matches.sql'),
  'utf8'
);
...
console.log('RESET_AND_DELETE_POLICIES_OK');
