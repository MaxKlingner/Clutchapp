/**
 * Applique disputes_cancellations.sql via Management API.
 * Usage: node scripts/apply-disputes.mjs
 */
...
const query = fs.readFileSync(
  path.join(root, 'supabase', 'disputes_cancellations.sql'),
  'utf8'
);
