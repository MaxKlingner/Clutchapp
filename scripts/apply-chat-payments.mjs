/**
 * Applique chat_payments.sql via Management API.
 * Usage: node scripts/apply-chat-payments.mjs
 */
...
const query = fs.readFileSync(
  path.join(root, 'supabase', 'chat_payments.sql'),
  'utf8'
);
