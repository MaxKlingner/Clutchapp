/**
 * Applique seed_software_specialties.sql via Management API.
 * Usage: node scripts/apply-seed-software.mjs
 */
...
const query = fs.readFileSync(
  path.join(root, 'supabase', 'seed_software_specialties.sql'),
  'utf8'
);
