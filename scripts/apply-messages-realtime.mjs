/**
 * Applique messages_realtime.sql via Management API.
 * Usage: node scripts/apply-messages-realtime.mjs
 */
...
const query = fs.readFileSync(
  path.join(root, 'supabase', 'messages_realtime.sql'),
  'utf8'
);
...
console.log('MESSAGES_REALTIME_OK');
