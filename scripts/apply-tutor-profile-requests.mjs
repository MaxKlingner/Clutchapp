/**
 * Applique tutor_profile_requests.sql via Management API.
 * Usage: node scripts/apply-tutor-profile-requests.mjs
 */
...
const query = fs.readFileSync(
  path.join(root, 'supabase', 'tutor_profile_requests.sql'),
  'utf8'
);
...
console.log('TUTOR_PROFILE_REQUESTS_OK');
